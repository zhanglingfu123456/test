...
CREATE TABLE `t_data_view_product` (
  ...
  `createtime` datetime DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=745 DEFAULT CHARSET=utf8 COMMENT='数据统计   商品';
...
) ENGINE=InnoDB AUTO_INCREMENT=2291 DEFAULT CHARSET=utf8 COMMENT='用户收货地址表';
